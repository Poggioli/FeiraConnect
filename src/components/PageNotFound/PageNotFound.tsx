...
export const PageNotFound = forwardRef<
  HTMLDivElement,
  HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => {

  return (
    <div ref={ref} {...props} className={cn("p-6 md:p-12 min-h-full w-full flex flex-col justify-center items-center max-w-screen-lg m-auto", className)}>
